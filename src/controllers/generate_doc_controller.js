...
const generateProgramDocumentation = async (req, res) => {
  try {
    let combinedCode = "";
    const { code } = req.body;
    ...
    const result = await ai_service.generateDocumentation(finalCode);
...
module.exports = generateProgramDocumentation;
